                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/banhang/tao-nhom')}}" method="post">
                                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nhom_ten" class="form-control" id="exampleInputEmail1" placeholder="Tên nhà cung cấp">
                                </div>
                              
                          
                                 <button type="submit" name="taonhom" class="btn btn-info">Lưu</button>
