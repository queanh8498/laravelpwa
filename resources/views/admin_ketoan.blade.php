    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{URL::to('ketoan/tongquanketoan')}}">
                    ...
                    <ul class="sub">
                        <li><a href="#">Danh mục kho xuất hàng</a></li>
                        <li><a href="#">Danh mục hàng hóa</a></li>
                        <li><a href="#">Danh mục nhóm hàng hóa</a></li>
                    ...
                    <ul class="sub">
                        <li><a href="#">Tổng kết công nợ</a></li>
                        <li><a href="#">Nợ tới hạn</a></li>
